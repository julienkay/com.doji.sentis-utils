...
#pragma warning restore CS0649
        ...
        public TensorIndex(int[] index)
            : this()
        {
            UnityEngine.Debug.AssertFormat(index.Length <= maxRank, "ValueError: TensorIndex are capped to rank=8, cannot create tensorindex of rank {0}", index.Length);
        ...
        {
            UnityEngine.Debug.AssertFormat(rank <= maxRank, "ValueError: TensorIndex are capped to rank=8, cannot create empty index of rank {0}", rank);
        ...
        {
            UnityEngine.Debug.AssertFormat(axis >= -rank && axis < rank, "IndexError: axis {0} is out of bounds index of rank, {1}", axis, rank);
