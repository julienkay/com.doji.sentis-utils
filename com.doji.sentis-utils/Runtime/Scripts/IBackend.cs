...
namespace Doji.AI {
    ...
    public interface IBackend : IDisposable {
        ...
        void Dense(Tensor<float> X, Tensor<float> W, Tensor<float> B, Tensor<float> O, FusableActivation fusedActivation);
        ...
        void Conv(Tensor<float> X, Tensor<float> K, Tensor<float> B, Tensor<float> O, int groups, Span<int> strides, Span<int> pads, Span<int> dilations, FusableActivation fusedActivation);
        ...
        /// <param name="fusedActivation">The fused activation type to apply after the convolution.</param>
        void ConvTranspose(Tensor<float> X, Tensor<float> W, Tensor<float> B, Tensor<float> O, Span<int> strides, Span<int> pads, Span<int> outputPadding, FusableActivation fusedActivation);
        ...
        void Resize(Tensor<float> X, Tensor<float> O, ReadOnlySpan<float> scale, InterpolationMode interpolationMode, NearestMode nearestMode, CoordTransformMode coordTransformMode);
        ...
        void GridSample(Tensor<float> X, Tensor<float> grid, Tensor<float> O, InterpolationMode mode, PaddingMode paddingMode, bool alignCorners);
        ...
        void DepthToSpace(Tensor<float> X, Tensor<float> O, int blocksize, DepthToSpaceMode mode);
        ...
        void Pad(Tensor<float> X, Tensor<float> O, ReadOnlySpan<int> pad, PadMode padMode, float constant);
        ...
        /// <param name="padMode">The `PadMode` to use when padding.</param>
        /// <param name="constant">The constant value to fill with.</param>
        void Pad(Tensor<int> X, Tensor<int> O, ReadOnlySpan<int> pad, PadMode padMode, int constant);
        ...
        void RoiAlign(Tensor<float> X, Tensor<float> rois, Tensor<int> indices, Tensor<float> O, RoiPoolingMode mode, int outputHeight, int outputWidth, int samplingRatio, float spatialScale);
        ...
        void ScatterElements(Tensor X, Tensor<int> indices, Tensor updates, Tensor O, int axis, ScatterReductionMode reduction);
        ...
        /// <param name="O">The output tensor to be computed and filled.</param>
        /// <param name="reduction">The reduction mode used to update the values as a `ScatterReductionMode`.</param>
        void ScatterND(Tensor<float> X, Tensor<int> indices, Tensor<float> updates, Tensor<float> O, ScatterReductionMode reduction);
        ...
        /// <param name="O">The output tensor to be computed and filled.</param>
        /// <param name="reduction">The reduction mode used to update the values as a `ScatterReductionMode`.</param>
        void ScatterND(Tensor<int> X, Tensor<int> indices, Tensor<int> updates, Tensor<int> O, ScatterReductionMode reduction);
        ...
        void LSTM(Tensor<float> X, Tensor<float> W, Tensor<float> R, Tensor<float> B, Tensor<int> sequenceLens, Tensor<float> initialH, Tensor<float> initialC, Tensor<float> P, Tensor<float> Y, Tensor<float> Yh, Tensor<float> Yc, RnnDirection direction, RnnActivation[] activations, float[] activationAlpha, float[] activationBeta, bool inputForget, float clip, RnnLayout layout);
